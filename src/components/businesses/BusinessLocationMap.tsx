...
const ClientSideMap = dynamic(() => import("../map/ClientSideMap"), {
  ssr: false,
  loading: () => (
...
const BusinessLocationMap = ({
      ...
      <Card className="w-full h-[300px] flex items-center justify-center">
        <div className="text-center p-6">
          ...
          <p className="text-muted-foreground mb-4">
            GPS coordinates are not available for this business.
          </p>
        </div>
      </Card>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <ClientSideMap location={location} title={businessName} />
