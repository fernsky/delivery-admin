...
interface ReligiousPlaceMediaSectionProps {
  religiousPlaceId: string;
  existingMedia: MediaFile[];
}

export function ReligiousPlaceMediaSection({
  religiousPlaceId,
  existingMedia,
}: ReligiousPlaceMediaSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Religious Place Photos</CardTitle>
        <CardDescription>
          Upload or manage photos for this religious place
        </CardDescription>
      </CardHeader>
