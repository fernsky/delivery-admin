...
interface ReligiousPlaceLocationMapProps {
  formData: FormData;
  updateMapData: (data: {
...
export default function ReligiousPlaceLocationMap({
  formData,
  updateMapData,
  updateFormData,
}: ReligiousPlaceLocationMapProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <Label htmlFor="areaInSquareMeters">
          {t("create.physicalDetails.areaInSquareMeters")}
        </Label>
        <Input
          ...
          placeholder={t(
            "create.physicalDetails.areaInSquareMetersPlaceholder",
          )}
          className="mt-1"
        />
      </div>
      ...
      <div>
        ...
        <Card className="mt-1 overflow-hidden">
          <MapComponent
            ...
            initialPolygon={
              formData.complexBoundary
                ? formData.complexBoundary.coordinates[0].map((coord) => ({
                    lat: coord[1],
                    lng: coord[0],
                  }))
                : undefined
