...
interface HistoricalSiteMediaSectionProps {
  siteId: string;
  existingMedia: MediaFile[];
  entityType: "HISTORICAL_SITE";
}

export function HistoricalSiteMediaSection({
  siteId,
  existingMedia,
  entityType,
}: HistoricalSiteMediaSectionProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="text-lg font-medium">ऐतिहासिक स्थलको फोटोहरू</div>
