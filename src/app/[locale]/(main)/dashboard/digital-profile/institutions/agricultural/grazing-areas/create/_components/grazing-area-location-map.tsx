  ...
  useEffect(() => {
    ...
    const pointVectorLayer = new VectorLayer({
      ...
      style: new Style({
        image: new Circle({
          radius: 7,
          fill: new Fill({ color: "#8b5cf6" }), // Purple color for grazing area points
    ...
    const polygonVectorLayer = new VectorLayer({
      ...
      style: new Style({
        fill: new Fill({ color: "rgba(139, 92, 246, 0.2)" }), // Purple with transparency for grazing area polygon
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="p-3 border-t bg-muted/20 text-xs">
        {isPointDrawing ? (
          <p>चरन खर्क क्षेत्रको स्थान राख्न नक्सामा क्लिक गर्नुहोस्</p>
        ) : isPolygonDrawing ? (
          <p>
            चरन खर्क क्षेत्रको सीमाङ्कन गर्न नक्सामा क्लिक गर्नुहोस् र बन्द गर्न
            डबल क्लिक गर्नुहोस्
          </p>
        ) : (
          <p>
            चरन खर्क क्षेत्रको स्थान वा क्षेत्र अंकन गर्न माथिको बटन क्लिक
            गर्नुहोस्
          </p>
        )}
      </div>
