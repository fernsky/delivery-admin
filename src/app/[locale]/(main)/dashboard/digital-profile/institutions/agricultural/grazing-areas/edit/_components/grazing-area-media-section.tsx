...
interface GrazingAreaMediaSectionProps {
  grazingAreaId: string;
  existingMedia: MediaFile[];
}

export function GrazingAreaMediaSection({
  grazingAreaId,
  existingMedia,
}: GrazingAreaMediaSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>चरन खर्क क्षेत्रको फोटोहरू</CardTitle>
        <CardDescription>
          चरन खर्क क्षेत्रको फोटोहरू अपलोड वा व्यवस्थापन गर्नुहोस्
        </CardDescription>
      </CardHeader>
