...
interface GrasslandMediaSectionProps {
  grasslandId: string;
  existingMedia: MediaFile[];
}

export function GrasslandMediaSection({
  grasslandId,
  existingMedia,
}: GrasslandMediaSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>चरन क्षेत्रको फोटोहरू</CardTitle>
        <CardDescription>
          चरन क्षेत्रको फोटोहरू अपलोड वा व्यवस्थापन गर्नुहोस्
        </CardDescription>
      </CardHeader>
