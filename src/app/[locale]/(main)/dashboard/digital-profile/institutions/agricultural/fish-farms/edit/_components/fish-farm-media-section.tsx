...
import { Trash2, Fish } from "lucide-react";
...
interface FishFarmMediaSectionProps {
  fishFarmId: string;
  existingMedia: MediaFile[];
}

export function FishFarmMediaSection({
  fishFarmId,
  existingMedia,
}: FishFarmMediaSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Fish Farm Photos</CardTitle>
        <CardDescription>
          Upload or manage photos for this fish farm
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {mediaFiles.length === 0 && !loadingUrls && (
          <div className="text-center py-12 text-muted-foreground mt-6">
            <Fish className="h-20 w-20 mx-auto opacity-10 mb-4" />
            <p>No photos found</p>
