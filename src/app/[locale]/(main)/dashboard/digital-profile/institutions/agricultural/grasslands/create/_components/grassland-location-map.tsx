  ...
  useEffect(() => {
    ...
    const pointVectorLayer = new VectorLayer({
      ...
      style: new Style({
        image: new Circle({
          radius: 7,
          fill: new Fill({ color: "#10b981" }), // Green color for grassland points
    ...
    const polygonVectorLayer = new VectorLayer({
      ...
      style: new Style({
        fill: new Fill({ color: "rgba(16, 185, 129, 0.2)" }), // Green with transparency for grassland polygon
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="p-3 border-t bg-muted/20 text-xs">
        {isPointDrawing ? (
          <p>चरन क्षेत्रको मुख्य स्थान राख्न नक्सामा क्लिक गर्नुहोस्</p>
        ) : isPolygonDrawing ? (
          <p>
            चरन क्षेत्रको सीमाङ्कन गर्न नक्सामा क्लिक गर्नुहोस् र बन्द गर्न डबल
            क्लिक गर्नुहोस्
          </p>
        ) : (
          <p>
            चरन क्षेत्रको स्थान वा क्षेत्र अंकन गर्न माथिको बटन क्लिक गर्नुहोस्
          </p>
        )}
      </div>
    </div>
