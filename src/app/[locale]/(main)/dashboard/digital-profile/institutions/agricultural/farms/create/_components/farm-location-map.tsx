...
interface FarmLocationMapProps {
  onGeometrySelect: (locationPoint?: Point, farmBoundary?: Polygon) => void;
  initialLocationPoint?: Point;
  initialFarmBoundary?: Polygon;
}
...
export function FarmLocationMap({
  ...
  const [wardOptions] = useState<number[]>(
  ...
  useEffect(() => {
    ...
    if (initialFarmBoundary) {
      try {
        const coords = initialFarmBoundary.coordinates[0].map((coord) =>
          fromLonLat(coord),
        );
  ...
  const startDrawingPoint = () => {
    ...
    drawInteractionRef.current.on("drawend", (event) => {
      ...
      let farmBoundary: Polygon | undefined = undefined;
  ...
  // Start drawing farm boundary polygon
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <Select>
            <SelectTrigger id="wardNumber" className="mt-1">
              <SelectValue placeholder="वडा नम्बर छान्नुहोस्" />
            </SelectTrigger>
            <SelectContent>
        ...
        <div>
          <FormLabel>स्थान/टोल</FormLabel>
          <Input id="location" placeholder="स्थान/टोल" className="mt-1" />
        </div>
        <div>
          <FormLabel>ठेगाना</FormLabel>
          <Input id="address" placeholder="ठेगाना" className="mt-1" />
        </div>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="p-3 border-t bg-muted/20 text-xs">
          {isPointDrawing ? (
            <p>फार्मको स्थान राख्न नक्सामा क्लिक गर्नुहोस्</p>
          ) : isPolygonDrawing ? (
            <p>
              फार्मको सीमाङ्कन गर्न नक्सामा क्लिक गर्नुहोस् र बन्द गर्न डबल
              क्लिक गर्नुहोस्
            </p>
          ) : (
            <p>फार्मको स्थान वा सीमा अंकन गर्न माथिको बटन क्लिक गर्नुहोस्</p>
          )}
        </div>
      </div>
    </div>
