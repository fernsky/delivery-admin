...
interface ProcessingCenterMediaSectionProps {
  processingCenterId: string;
  existingMedia: MediaFile[];
}

export function ProcessingCenterMediaSection({
  processingCenterId,
  existingMedia,
}: ProcessingCenterMediaSectionProps) {
  ...
  const handleFileUploadComplete = (fileData: any) => {
    ...
    addMedia({
      ...
      entityId: processingCenterId,
      entityType: "AGRI_PROCESSING_CENTER",
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>कृषि प्रशोधन केन्द्रको फोटोहरू</CardTitle>
        <CardDescription>
          कृषि प्रशोधन केन्द्रको फोटोहरू अपलोड वा व्यवस्थापन गर्नुहोस्
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {mediaFiles.length === 0 && !loadingUrls && (
          <div className="text-center py-12 text-muted-foreground mt-6">
            <Factory className="h-20 w-20 mx-auto opacity-10 mb-4" />
