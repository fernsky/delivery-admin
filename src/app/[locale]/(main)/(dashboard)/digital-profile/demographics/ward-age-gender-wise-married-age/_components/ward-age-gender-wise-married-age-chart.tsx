...
interface WardAgeGenderWiseMarriedAgeData {
  id: string;
  wardId: string;
  wardNumber?: number;
  ageGroup: string;
...
interface WardAgeGenderWiseMarriedAgeChartProps {
...
export default function WardAgeGenderWiseMarriedAgeChart({
  data,
}: WardAgeGenderWiseMarriedAgeChartProps) {
    ...
    return (
      <div className="text-center py-12">
        <p className="text-gray-500 text-lg">
          कुनै डाटा उपलब्ध छैन। पहिले वडा अनुसार उमेर, लिङ्ग र विवाह उमेर डाटा
          थप्नुहोस्।
        </p>
      </div>
    );
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>वडा अनुसार उमेर, लिङ्ग र विवाह उमेर विश्लेषण</CardTitle>
        <CardDescription>
          वडा, उमेर समूह र लिङ्ग अनुसार विवाह उमेर जनसंख्या डाटा हेर्नुहोस्
        </CardDescription>
