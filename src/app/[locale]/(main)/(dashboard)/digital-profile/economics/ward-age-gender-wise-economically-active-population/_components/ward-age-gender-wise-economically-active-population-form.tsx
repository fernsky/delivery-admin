...
const getAgeGroupOptions = () => {
  const enumValues = Object.values(EconomicallyActiveAgeGroupEnum.Values);
  return enumValues.map((value) => {
    let label;
    switch (value) {
      case "AGE_0_TO_14":
        label = "० देखि १४ वर्ष";
        break;
      case "AGE_15_TO_59":
        label = "१५ देखि ५९ वर्ष";
        break;
      case "AGE_60_PLUS":
        label = "६० वर्ष वा सोभन्दा बढी";
        break;
      default:
        label = value;
    }
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="border-t pt-4">
          <h3 className="text-lg font-medium mb-4">
            उमेर, लिङ्ग र आर्थिक रुपमा सक्रिय जनसंख्या विवरण
          </h3>
