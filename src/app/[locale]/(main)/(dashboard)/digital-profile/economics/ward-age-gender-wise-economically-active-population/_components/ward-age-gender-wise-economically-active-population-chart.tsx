...
interface WardAgeGenderWiseEconomicallyActivePopulationChartProps {
...
export default function WardAgeGenderWiseEconomicallyActivePopulationChart({
  data,
}: WardAgeGenderWiseEconomicallyActivePopulationChartProps) {
    ...
    return (
      <div className="text-center py-12">
        <p className="text-gray-500 text-lg">
          कुनै डाटा उपलब्ध छैन। पहिले वडा अनुसार उमेर, लिङ्ग र आर्थिक रुपमा
          सक्रिय जनसंख्या डाटा थप्नुहोस्।
        </p>
      </div>
    );
  }
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>
          वडा अनुसार उमेर, लिङ्ग र आर्थिक रुपमा सक्रिय जनसंख्या विश्लेषण
        </CardTitle>
        <CardDescription>
          वडा, उमेर समूह र लिङ्ग अनुसार आर्थिक रुपमा सक्रिय जनसंख्या डाटा
          हेर्नुहोस्
        </CardDescription>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="p-4">
            <div className="text-sm font-medium text-muted-foreground mb-1">
              कुल आर्थिक रुपमा सक्रिय जनसंख्या
            </div>
