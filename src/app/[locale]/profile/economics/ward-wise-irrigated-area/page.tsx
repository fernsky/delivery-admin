...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const irrigatedAreaData = await api.profile.economics.wardWiseIrrigatedArea.getAll.query();
    ...
    const irrigationCoverage = totalArea > 0 ? (totalIrrigatedArea / totalArea) * 100 : 0;

    // Find ward with highest irrigation coverage
    let highestCoverageWard = null;
    ...
    const descriptionNP = `खजुरा गाउँपालिकाको वडा अनुसार सिंचित क्षेत्रको विस्तृत विश्लेषण। कुल ${localizeNumber(totalArea.toFixed(1), "ne")} हेक्टर कृषि क्षेत्रमध्ये ${localizeNumber(totalIrrigatedArea.toFixed(1), "ne")} हेक्टर (${localizeNumber(irrigationCoverage.toFixed(1), "ne")}%) सिंचित छ। वडा नं. ${localizeNumber(highestCoverageWard?.toString() || "", "ne")} मा सर्वाधिक ${localizeNumber(highestCoveragePercentage.toFixed(1), "ne")}% सिंचाई कभरेज रहेको छ।`;
    ...
    return {
      ...
      description: "खजुरा गाउँपालिकाको वडा अनुसार सिंचित र असिंचित कृषि क्षेत्रको विस्तृत विश्लेषण।",
    };
  }
}
...
const toc = [
  ...
  { level: 2, text: "पालिकाको सिंचाई अवस्था", slug: "municipality-irrigation-status" },
  { level: 2, text: "वडा अनुसार सिंचाई कभरेज", slug: "ward-wise-irrigation-coverage" },
...
export default async function WardWiseIrrigatedAreaPage() {
  ...
  try {
    summaryData = await api.profile.economics.wardWiseIrrigatedArea.summary.query();
  } catch (error) {
  ...
  const totalArea = totalIrrigatedArea + totalUnirrigatedArea;
  const irrigationCoveragePercentage = totalArea > 0 ? (totalIrrigatedArea / totalArea) * 100 : 0;
  ...
  const wardWiseData = wardNumbers.map((wardNumber) => {
    ...
    const irrigated = parseFloat(wardItem.irrigatedAreaHectares.toString());
    const unirrigated = parseFloat(wardItem.unirrigatedAreaHectares.toString());
  ...
  const wardWiseAnalysis = wardNumbers.map((wardNumber) => {
    ...
    const irrigationCoverage = totalWardArea > 0
  ...
  }).filter(Boolean).sort((a, b) => b.irrigationCoverage - a.irrigationCoverage); // Sort by coverage
      ...
      <div className="flex flex-col gap-8">
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              सिंचाई कृषि उत्पादनको मेरुदण्ड हो र खाद्य सुरक्षाको आधार पनि। नेपालको कृषि प्रधान अर्थतन्त्रमा सिंचाई सुविधाको पहुँच र वितरणले कृषकहरूको जीवनयात्रालाई प्रत्यक्ष प्रभाव पार्छ। खजुरा गाउँपालिकामा पनि सिंचाई सुविधाको उपलब्धता र वितरणले स्थानीय कृषि उत्पादन र किसानहरूको आर्थिक अवस्थामा महत्त्वपूर्ण भूमिका खेलेको छ।
            </p>
            <p>
              खजुरा गाउँपालिकाको सिंचाई सम्बन्धी तथ्याङ्क अनुसार, कुल {localizeNumber(totalArea.toFixed(1), "ne")} 
              हेक्टर कृषि क्षेत्रमध्ये {localizeNumber(totalIrrigatedArea.toFixed(1), "ne")} हेक्टर अर्थात् 
              {localizeNumber(irrigationCoveragePercentage.toFixed(1), "ne")}% क्षेत्रमा सिंचाई सुविधा उपलब्ध छ। यसमध्ये 
              वडा नं. {localizeNumber(bestPerformingWard?.wardNumber.toString() || "", "ne")} मा सबैभन्दा बढी 
              {localizeNumber(bestPerformingWard?.irrigationCoverage.toFixed(1) || "0", "ne")}% सिंचाई कभरेज रहेको छ।
            </p>
            ...
            <p>
              खजुरा गाउँपालिकाको सिंचाई अवस्थाको समग्र मूल्याङ्कन गर्दा निम्नलिखित तथ्यहरू देखिन्छन्:
            </p>
            
            <ul>
              <li>
                <strong>कुल कृषि क्षेत्र:</strong> {localizeNumber(totalArea.toFixed(1), "ne")} हेक्टर
              </li>
              <li>
                <strong>सिंचित क्षेत्र:</strong> {localizeNumber(totalIrrigatedArea.toFixed(1), "ne")} हेक्टर 
                ({localizeNumber(irrigationCoveragePercentage.toFixed(1), "ne")}%)
              </li>
              <li>
                <strong>असिंचित क्षेत्र:</strong> {localizeNumber(totalUnirrigatedArea.toFixed(1), "ne")} हेक्टर 
                ({localizeNumber((100 - irrigationCoveragePercentage).toFixed(1), "ne")}%)
              </li>
              <li>
                <strong>सिंचाई प्रभावकारिता स्कोर:</strong> {localizeNumber(overallEfficiencyScore.toString(), "ne")}%
              </li>
            </ul>

            <p>
              सिंचाई कभरेजको विश्लेषण गर्दा, खजुरा गाउँपालिकामा सिंचाई पहुँच {irrigationCoveragePercentage >= 60 ? "राम्रो" : irrigationCoveragePercentage >= 40 ? "सन्तोषजनक" : "सुधार आवश्यक"} 
              स्तरमा रहेको छ। तथापि, वडागत भिन्नताले सिंचाई पूर्वाधारको समान वितरणमा चुनौती देखाउँछ।
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              ...
              कुल {localizeNumber(totalArea.toFixed(1), "ne")} हेक्टर कृषि योग्य भूमिमध्ये {localizeNumber(totalIrrigatedArea.toFixed(1), "ne")} 
              हेक्टर क्षेत्रमा सिंचाई पहुँच पुगेको छ, जसले {localizeNumber(irrigationCoveragePercentage.toFixed(1), "ne")}% कभरेज दर दर्शाउँछ।
            </p>
            
            <p>
              तथापि, वडागत असन्तुलनले सिंचाई पूर्वाधारको समान वितरणमा चुनौती खडा गरेको छ। विशेषगरी वडा नं. 
              {localizeNumber(worstPerformingWard?.wardNumber.toString() || "", "ne")} मा मात्र {localizeNumber(worstPerformingWard?.irrigationCoverage.toFixed(1) || "0", "ne")}% 
              सिंचाई कभरेज रहेकोले यस क्षेत्रमा सिंचाई पूर्वाधारको विस्तारमा प्राथमिकता दिनुपर्ने देखिन्छ।
            </p>
            ...
            <p>
              खजुरा गाउँपालिकाको सिंचाई अवस्थाको विश्लेषणबाट निम्न निष्कर्ष र सिफारिसहरू गर्न सकिन्छ:
            </p>
            ...
            <div className="pl-6 space-y-4">
              <div className="flex">
                ...
                <div>
                  <strong>सिंचाई विस्तार:</strong> हाल पालिकामा {localizeNumber((100 - irrigationCoveragePercentage).toFixed(1), "ne")}% 
                  कृषि क्षेत्र असिंचित रहेकोले सिंचाई पूर्वाधारको विस्तारमा विशेष जोड दिनुपर्ने। विशेषगरी वडा नं. 
                  {localizeNumber(worstPerformingWard?.wardNumber.toString() || "", "ne")} जस्ता कम कभरेज भएका क्षेत्रहरूमा प्राथमिकता दिनुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">२.</span>
                <div>
                  <strong>वडागत सन्तुलन:</strong> सिंचाई सुविधाको वडागत असन्तुलनलाई सम्बोधन गर्न समान वितरणको नीति अवलम्बन गर्नुपर्ने। 
                  उच्च कभरेज भएका वडाहरूको अनुभव र प्रविधि अन्य वडाहरूमा हस्तान्तरण गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">३.</span>
                <div>
                  <strong>प्रविधि सुधार:</strong> परम्परागत सिंचाई प्रणालीमा आधुनिक प्रविधिको समावेश गरी पानीको दक्ष उपयोग सुनिश्चित गर्नुपर्ने। 
            ...
            <p className="mt-6">
              खजुरा गाउँपालिकामा सिंचाई सुविधाको वर्तमान अवस्थाले सिंचाई पूर्वाधारमा व्यापक सुधार गर्नुपर्ने 
              आवश्यकता देखाउँछ। समान पहुँच, दक्ष प्रविधि र दिगो व्यवस्थापनमा जोड दिई कार्यान्वयन गर्न आवश्यक देखिन्छ।
            </p>
          </div>
        </section>
      </div>
