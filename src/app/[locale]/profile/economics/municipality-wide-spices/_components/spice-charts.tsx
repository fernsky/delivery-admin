        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          >
            <h3 className="text-lg font-medium mb-4">
              मसलाबालीको प्रकार अनुसार उत्पादन वितरण
            </h3>
          ...
          >
            <h3 className="text-lg font-medium mb-4">
              मसलाबालीको प्रकार अनुसार बिक्री र आम्दानी
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardContent className="pt-6">
              ...
              <div>
                ...
                <div className="bg-muted/50 p-4 rounded-md border mt-6">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr>
                        <th className="text-left">मसलाबाली प्रकार</th>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-muted/50 p-4 rounded-md border">
                  <h4 className="font-medium mb-2">मसलाबाली बिक्री दर</h4>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-muted/50 p-4 rounded-md border">
                ...
                <p className="text-sm">
                  ...
                  पुगेको छ। त्यसैगरी, खुर्सानी र धनिया उत्पादनमा पनि निरन्तर
                  वृद्धि भएको देखिन्छ।
                </p>
                <p className="text-sm mt-2">
                  यो तथ्याङ्कले खजुरा गाउँपालिकामा मसलाबालीको क्षेत्रमा
