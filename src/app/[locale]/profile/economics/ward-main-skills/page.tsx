...
const SKILL_NAMES_EN: Record<string, string> = {
  ...
  PHOTOGRAPHY_RELATED: "Photography Skills",
  HANDICRAFT_RELATED: "Handicraft Skills",
  MUSIC_DRAMA_RELATED: "Music & Drama",
  STONEWORK_WOODWORK: "Stone & Wood Work",
  CARPENTERY_RELATED: "Carpentry Skills",
  PLUMBING: "Plumbing",
  HUMAN_HEALTH_RELATED: "Human Health Services",
  ANIMAL_HEALTH_RELATED: "Animal Health Services",
  ELECTRICITY_INSTALLMENT_RELATED: "Electrical Installation",
  HOTEL_RESTAURANT_RELATED: "Hotel & Restaurant",
  AGRICULTURE_RELATED: "Agricultural Skills",
  ...
  SHOEMAKING_RELATED: "Shoemaking",
  SEWING_RELATED: "Sewing & Tailoring",
  JWELLERY_MAKING_RELATED: "Jewelry Making",
  BEUATICIAN_RELATED: "Beauty & Cosmetics",
  SELF_PROTECTION_RELATED: "Self-Protection",
  LAND_SURVEY_RELATED: "Land Surveying",
  COMPUTER_SCIENCE_RELATED: "Computer Science",
  ENGINEERING_DESIGN_RELATED: "Engineering Design",
  RADIO_TELEVISION_ELECTRICAL_REPAIR: "Electronics Repair",
