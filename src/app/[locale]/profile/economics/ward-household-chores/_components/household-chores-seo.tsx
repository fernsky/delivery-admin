...
export default function HouseholdChoresSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Household Chores Time Distribution in Khajura Rural Municipality (खजुरा गाउँपालिका)",
      ...
      url: "https://khajuramun.digprofile.com/profile/economics/ward-household-chores",
      creator: {
        "@type": "Organization",
      ...
      distribution: {
        ...
        encodingFormat: "CSV",
        contentUrl:
          "https://khajuramun.digprofile.com/data/household-chores-time-distribution.csv",
      },
    };
  };
