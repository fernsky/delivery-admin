...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "खजुरा गाउँपालिका घरायसी कामकाज",
      "घरायसी कामकाजमा समय वितरण",
      `खजुरा ${TIME_SPENT_NAMES_NP[topTimeCategories[0]]} घरायसी काम`,
      ...
      `खजुरा जनसंख्या घरायसी काम ${totalPopulation}`,
    ];
...
export default async function WardHouseholdChoresPage() {
  ...
  const wardWiseData = wardNumbers.map((wardNumber) => {
    ...
    wardData.forEach((item) => {
      result[TIME_SPENT_NAMES[item.timeSpent] || item.timeSpent] =
        item.population;
    });
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी कामकाज - खजुरा गाउँपालिका (Household Chores - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              खजुरा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समय
            </h1>
            ...
            <p>
              यस खण्डमा खजुरा गाउँपालिकाको विभिन्न वडाहरूमा घरायसी कामकाजमा
            ...
            <p>
              खजुरा गाउँपालिकामा कुल {totalPopulation.toLocaleString()} जनसंख्या
              मध्ये सबैभन्दा बढी{" "}
            ...
            <p>
              घरायसी कामकाजमा खर्चिने समय अनुसार खजुरा गाउँपालिकाको जनसंख्या
              वितरण निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              खजुरा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समयको विश्लेषण गर्दा
