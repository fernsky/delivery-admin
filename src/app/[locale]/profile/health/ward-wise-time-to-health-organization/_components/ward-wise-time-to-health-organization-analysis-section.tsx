...
export default function WardWiseTimeToHealthOrganizationAnalysisSection({
  ...
  const accessibilityLevel = 
    accessibilityIndex >= 75 ? "उत्तम" :
    accessibilityIndex >= 60 ? "राम्रो" :
    accessibilityIndex >= 40 ? "मध्यम" :
    "निम्न";
  ...
  const poorAccessPercentage = ((poorAccessTotal / totalHouseholds) * 100).toFixed(2);
    ...
    <>
      ...
      >
        {Object.keys(TIME_CATEGORIES).map((categoryKey) => {
          const category = TIME_CATEGORIES[categoryKey as keyof typeof TIME_CATEGORIES];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Ward with Best Health Facility Access in Khajura Rural Municipality
              </span>
            </h4>
            {bestAccessWard && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(bestAccessWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    छिटो पहुँच दर: {localizeNumber(bestAccessWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा अधिकांश घरधुरीले छिटो स्वास्थ्य सेवा पाउने सुविधा रहेको छ, जुन पालिकाको औसतभन्दा {localizeNumber((bestAccessWard.percentage - parseFloat(quickAccessPercentage)).toFixed(2), "ne")}% ले उच्च छ।
                </p>
                <p className="text-sm">
                  यसले यस वडामा स्वास्थ्य पूर्वाधार र स्वास्थ्य संस्थाको पर्याप्त वितरण भएको संकेत गर्दछ।
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Poor Health Facility Access in Khajura</span>
            </h4>
            {worstAccessWard && (
              <div className="flex items-center gap-3">
                <div
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(worstAccessWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    छिटो पहुँच दर: {localizeNumber(worstAccessWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 p-3 bg-red-50 rounded-lg border border-red-100">
                <p className="text-sm">
                  यस वडामा स्वास्थ्य संस्था पहुँचको स्थिति कमजोर रहेको देखिन्छ। अधिकांश घरधुरीहरूले स्वास्थ्य सेवा लिन धेरै समय लगाउनु पर्ने अवस्था छ। यस वडामा स्वास्थ्य सेवा विस्तार वा घुम्ती स्वास्थ्य सेवा कार्यक्रम लागू गर्न आवश्यक छ।
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-center mb-4">
              ...
              <p className="mt-2 text-sm font-medium">{accessibilityLevel} स्तर</p>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> स्वास्थ्य पहुँच सूचकाङ्क विभिन्न समय श्रेणीहरूको भारित औसतमा आधारित छ, जसमा छिटो पहुँचलाई बढी भार दिइएको छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((accessibilityIndex).toFixed(1), "ne")} अंकले {accessibilityLevel} स्वास्थ्य पहुँच दर्शाउँछ। यसमा सुधारका लागि दूरदराजका क्षेत्रहरूमा स्वास्थ्य सेवा विस्तार गर्नुपर्ने देखिन्छ।
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div>
              <h5 className="text-sm font-medium">छिटो पहुँच (३० मिनेटभित्र)</h5>
              <div className="mt-2 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        ...
                        style={{ backgroundColor: TIME_CATEGORIES.UNDER_15_MIN.color }}
                      ></span>
                      {TIME_CATEGORIES.UNDER_15_MIN.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(timeCategoryPercentages.UNDER_15_MIN.toFixed(2), "ne")}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        className="inline-block w-2 h-2 rounded-full mr-2" 
                        style={{ backgroundColor: TIME_CATEGORIES.UNDER_30_MIN.color }}
                      ></span>
                      {TIME_CATEGORIES.UNDER_30_MIN.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(timeCategoryPercentages.UNDER_30_MIN.toFixed(2), "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                ...
                <div className="pt-2 mt-2 border-t">
                  <div className="flex justify-between text-sm font-medium">
                    ...
                    <span>
                      {localizeNumber(quickAccessPercentage, "ne")}%
                    </span>
                  </div>
                  <p className="text-sm mt-2 text-muted-foreground">
                    कुल {localizeNumber(quickAccessTotal.toLocaleString(), "ne")} घरधुरीले ३० मिनेटभित्र स्वास्थ्य संस्था पुग्न सक्छन्
                  </p>
                </div>
              </div>
            </div>
