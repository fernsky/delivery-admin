...
interface TimeToHealthOrganizationBarChartProps {
...
export default function TimeToHealthOrganizationBarChart({
  wardWiseData,
  TIME_CATEGORIES,
}: TimeToHealthOrganizationBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(TIME_CATEGORIES).map((category, index, arr) => (
          <Bar
            key={category.name}
