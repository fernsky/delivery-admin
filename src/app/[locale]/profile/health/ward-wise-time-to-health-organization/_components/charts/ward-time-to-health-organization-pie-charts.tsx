...
interface WardTimeToHealthOrganizationPieChartsProps {
...
export default function WardTimeToHealthOrganizationPieCharts({
  wardWiseData,
  TIME_CATEGORIES,
}: WardTimeToHealthOrganizationPieChartsProps) {
