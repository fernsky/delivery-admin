...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "ne_NP",
    siteName: "पालिका प्रोफाइल पोर्टल",
  },
};
      ...
      <div className="flex flex-col gap-8">
        <section className="py-6">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              यस पालिका प्रोफाइल पोर्टलमा स्वागत छ! यहाँ तपाईंले स्थानीय
              समुदायको विस्तृत तथ्याङ्क, सूचना र विश्लेषणहरू पाउनुहुनेछ। यो
              पोर्टल सरकारी निकायहरू, अनुसन्धानकर्ताहरू, विद्यार्थीहरू र सामान्य
              नागरिकहरूको लागि एक महत्वपूर्ण स्रोत हो।
            </p>
            <p>
              नेपालको स्थानीय तहको विकेन्द्रीकरण र सशक्तिकरणलाई ध्यानमा राख्दै
              यो पोर्टलले विभिन्न क्षेत्रहरूमा महत्वपूर्ण तथ्याङ्कहरू प्रदान
              गर्दछ। यसले पालिकाको योजना निर्माण, नीति निर्धारण र निर्णय
              प्रक्रियामा सहयोग पुर्‍याउने विश्वास गरिएको छ।
            </p>

            <h2 id="data-categories" className="scroll-m-20 pt-4">
              तथ्याङ्क श्रेणीहरू
            </h2>
            <p>यस पोर्टलमा निम्न श्रेणीहरूमा तथ्याङ्क उपलब्ध छन्:</p>
          </div>
        </section>
        ...
        <section className="py-6">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h2 id="how-to-use" className="scroll-m-20">
              पोर्टलको प्रयोग विधि
            </h2>
            <p>
              यो पोर्टल प्रयोग गर्न सजिलो छ। तपाईंले निम्न तरिकाले तथ्याङ्क
            ...
            <p>
              यस पोर्टलमा प्रस्तुत गरिएका तथ्याङ्कहरू निम्न स्रोतहरूबाट संकलन
              गरिएका हुन्:
            </p>
            <ul>
