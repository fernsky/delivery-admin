...
interface EducationalLevelBarChartProps {
...
export default function EducationalLevelBarChart({
  wardWiseData,
  EDUCATIONAL_LEVEL_GROUPS,
}: EducationalLevelBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(EDUCATIONAL_LEVEL_GROUPS).map((group, index, arr) => (
          <Bar
            key={group.name}
            dataKey={group.name}
            name={group.name}
