...
export default function WardWiseEducationalLevelAnalysisSection({
  ...
  const educationLevel = 
    educationIndex >= 0.5 ? "उच्च" :
    educationIndex >= 0.3 ? "मध्यम" :
    "आधारभूत";
  ...
  const seoAttributes = {
    ...
    "data-higher-education-rate": educationGroupPercentages.HIGHER_EDUCATION.toFixed(2),
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Ward with Highest Higher Education Rate in Khajura Rural Municipality
              </span>
            </h4>
            {bestEducatedWard && (
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    backgroundColor: EDUCATIONAL_LEVEL_GROUPS.HIGHER_EDUCATION.color,
                  }}
                ></div>
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(bestEducatedWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    उच्च शिक्षा दर: {localizeNumber(bestEducatedWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {bestEducatedWard.percentage.toFixed(2)}% higher education rate
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा उच्च शिक्षा हासिल गरेको जनसंख्याको प्रतिशत सबैभन्दा बढी रहेको छ, जुन पालिकाको औसतभन्दा {localizeNumber((bestEducatedWard.percentage - educationGroupPercentages.HIGHER_EDUCATION).toFixed(2), "ne")}% ले उच्च छ।
                </p>
                <p className="text-sm">
                  यसले यस वडामा शैक्षिक संस्थाहरूको उपलब्धता, परिवारको आर्थिक अवस्था र शिक्षाप्रति सकारात्मक दृष्टिकोण रहेको संकेत गर्दछ।
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Low Higher Education Rate in Khajura</span>
            </h4>
            {leastEducatedWard && (
              <div className="flex items-center gap-3">
                <div
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(leastEducatedWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    उच्च शिक्षा दर: {localizeNumber(leastEducatedWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {leastEducatedWard.percentage.toFixed(2)}% higher education rate
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 p-3 bg-orange-50 rounded-lg border border-orange-100">
                <p className="text-sm">
                  यस वडामा उच्च शिक्षाको दर न्यून रहेको छ, जसले यहाँ शैक्षिक संस्थाहरूको पहुँच, आर्थिक अवस्था वा अन्य सामाजिक कारणहरूले उच्च शिक्षामा पहुँच कम भएको संकेत गर्दछ। यस वडामा शिक्षा प्रवर्द्धनका लागि विशेष कार्यक्रम सञ्चालन गर्नुपर्ने देखिन्छ।
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> शैक्षिक स्तरको यो सूचकाङ्क विभिन्न शैक्षिक स्तरहरूको भारित औसतमा आधारित छ, जहाँ उच्च शिक्षालाई बढी भार दिइएको छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((educationIndex * 100).toFixed(1), "ne")} अंकले {educationLevel} शैक्षिक स्तर दर्शाउँछ। यसमा सुधारका लागि उच्च शिक्षा प्रवर्द्धनका कार्यक्रमहरू आवश्यक छन्।
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div>
              <h5 className="text-sm font-medium">सबैभन्दा बढी जनसंख्या भएको शैक्षिक स्तर</h5>
              <div className="mt-2 space-y-3">
                <div>
                  <div className="flex justify-between text-sm">
                    <span>
                      {highestSignificantLevel && educationalLevelMap[highestSignificantLevel] ? educationalLevelMap[highestSignificantLevel] : "अज्ञात"}
                    </span>
                    <span className="font-medium">
                      {highestLevelPopulation > 0 ? 
                        localizeNumber(((highestLevelPopulation / totalPopulation) * 100).toFixed(2), "ne") : "0.00"}%
                    </span>
                  </div>
                ...
                <div className="mt-4 pt-3 border-t">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {localizeNumber(educationGroupPercentages.HIGHER_EDUCATION.toFixed(2), "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                  ...
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        ...
                        style={{ backgroundColor: EDUCATIONAL_LEVEL_GROUPS.SECONDARY.color }}
                      ></span>
                      माध्यमिक तह
                    </span>
                    <span className="font-medium">
                      {localizeNumber(educationGroupPercentages.SECONDARY.toFixed(2), "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: EDUCATIONAL_LEVEL_GROUPS.SECONDARY.color,
                      }}
                    ></div>
                  </div>
                </div>
