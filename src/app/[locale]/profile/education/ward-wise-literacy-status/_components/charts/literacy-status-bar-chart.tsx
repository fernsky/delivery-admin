...
interface LiteracyStatusBarChartProps {
...
export default function LiteracyStatusBarChart({
  wardWiseData,
  LITERACY_STATUS_TYPES,
}: LiteracyStatusBarChartProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        />
        <Bar
          dataKey={LITERACY_STATUS_TYPES.BOTH_READING_AND_WRITING.name}
        ...
        />
        <Bar
          dataKey={LITERACY_STATUS_TYPES.READING_ONLY.name}
          name={LITERACY_STATUS_TYPES.READING_ONLY.name}
          stackId="a"
          fill={LITERACY_STATUS_TYPES.READING_ONLY.color}
          radius={[0, 0, 0, 0]}
        />
        <Bar
          dataKey={LITERACY_STATUS_TYPES.ILLITERATE.name}
