...
export const stagingBusiness = pgTable("staging_product_business", {
...
export const business = pgTable("product_business", {
  id: varchar("id", { length: 48 }).primaryKey(),
...
export const businessEditRequests = pgTable("product_business_edit_requests", {
  id: varchar("id", { length: 48 }).primaryKey(),
...
export const businessWithUpdatedNames = pgTable(
  "product_business_with_updated_names",
  {
