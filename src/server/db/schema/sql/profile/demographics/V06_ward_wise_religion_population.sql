...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM ward_wise_religion_population) THEN
        ...
        (gen_random_uuid(), 1, 'SIKH', 0, NOW(), NOW()),

        -- Ward 2
        (gen_random_uuid(), 2, 'BAHAI', 5, NOW(), NOW()),
        (gen_random_uuid(), 2, 'BON', 1, NOW(), NOW()),
        ...
        (gen_random_uuid(), 2, 'JAIN', 1, NOW(), NOW()),
        (gen_random_uuid(), 2, 'OTHER', 7, NOW(), NOW()),
        (gen_random_uuid(), 2, 'SIKH', 43, NOW(), NOW()),

        -- Ward 3
        (gen_random_uuid(), 3, 'BAHAI', 1, NOW(), NOW()),
        (gen_random_uuid(), 3, 'BON', 1, NOW(), NOW()),
        ...
        (gen_random_uuid(), 5, 'NATURE', 3, NOW(), NOW()),

        -- Ward 6
        (gen_random_uuid(), 6, 'BAHAI', 1, NOW(), NOW()),
        ...
        (gen_random_uuid(), 6, 'KIRANT', 1, NOW(), NOW()),
        (gen_random_uuid(), 6, 'OTHER', 1, NOW(), NOW()),

        -- Ward 7
        (gen_random_uuid(), 7, 'BON', 1, NOW(), NOW()),
        ...
        (gen_random_uuid(), 8, 'SIKH', 0, NOW(), NOW());
    END IF;
END
$$;
