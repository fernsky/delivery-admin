...
export const dairyIndustry = pgTable("dairy_industry", {
  ...
  establishmentStatus: establishmentStatusEnum("establishment_status").default("OPERATIONAL"),
  ...
  processingAreaSqm: decimal("processing_area_sqm", { precision: 10, scale: 2 }),
  storageAreaSqm: decimal("storage_area_sqm", { precision: 10, scale: 2 }),
  coldStorageAreaSqm: decimal("cold_storage_area_sqm", { precision: 10, scale: 2 }),
  
  // Milk sourcing
  milkSource: milkSourceEnum("milk_source").notNull(),
  dailyMilkCollectionLiters: decimal("daily_milk_collection_liters", { precision: 10, scale: 2 }),
  ...
  averageMilkPricePerLiterNPR: decimal("average_milk_price_per_liter_npr", { precision: 8, scale: 2 }),
  ...
  chillingCapacityLiters: decimal("chilling_capacity_liters", { precision: 10, scale: 2 }),
  
  // Production details
  dailyProcessingCapacityLiters: decimal("daily_processing_capacity_liters", { precision: 10, scale: 2 }),
  actualDailyProcessingLiters: decimal("actual_daily_processing_liters", { precision: 10, scale: 2 }),
  ...
  // Financial details
  initialInvestmentNPR: decimal("initial_investment_npr", { precision: 14, scale: 2 }),
  annualTurnoverNPR: decimal("annual_turnover_npr", { precision: 14, scale: 2 }),
  ...
  productsReturnRate: decimal("products_return_rate", { precision: 5, scale: 2 }),
  ...
  effluent?: text("effluent_treatment_plant"),
  
  // Cold chain
  hasColdChain: boolean("has_cold_chain").default(true),
  coldStorageCapacityLiters: decimal("cold_storage_capacity_liters", { precision: 10, scale: 2 }),
  ...
  // Accessibility
  distanceFromMainRoadKm: decimal("distance_from_main_road_km", { precision: 6, scale: 2 }),
  distanceFromCityOrBazarKm: decimal("distance_from_city_or_bazar_km", { precision: 6, scale: 2 }),
  ...
  hasRegularFoodSafetyInspection: boolean("has_regular_food_safety_inspection").default(false),
  inspectionFrequency: text("inspection_frequency"),
  lastInspectionDate: date("last_inspection_date"),
  
  // Linkages and associations
  memberOfDairyAssociation: boolean("member_of_dairy_association").default(false),
  ...
  linkedMilkCollectionCenters: jsonb("linked_milk_collection_centers").default(sql`'[]'::jsonb`),
