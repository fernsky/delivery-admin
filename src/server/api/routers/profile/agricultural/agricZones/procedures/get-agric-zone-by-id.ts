...
// Get agricultural zone by ID
export const getAgricZoneById = publicProcedure
  .input(z.string())
  .query(async ({ ctx, input }) => {
    try {
      ...
      console.error("Error fetching agricultural zone:", error);
