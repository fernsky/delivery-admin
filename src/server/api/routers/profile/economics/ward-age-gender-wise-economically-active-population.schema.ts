...
export const wardAgeGenderWiseEconomicallyActivePopulationFilterSchema = z.object({
...
>;
export type UpdateWardAgeGenderWiseEconomicallyActivePopulationData = WardAgeGenderWiseEconomicallyActivePopulationData;
