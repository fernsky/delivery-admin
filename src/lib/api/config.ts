  ...
  profile: {
    demographics: {
      wardWiseReligionPopulation: {
        ...
        byId: (id: string) => `/profile/demographics/ward-wise-religion-population/${id}`,
        byWard: (wardNumber: number) => `/profile/demographics/ward-wise-religion-population/ward/${wardNumber}`,
        byReligion: (religionType: string) => `/profile/demographics/ward-wise-religion-population/religion/${religionType}`,
        religionSummary: '/profile/demographics/ward-wise-religion-population/summary/religion',
        wardSummary: '/profile/demographics/ward-wise-religion-population/summary/ward',
      },
    },
  },
};
